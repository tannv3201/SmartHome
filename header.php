...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./image/image_database/logo.png">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/lykmapipo/themify-icons@0.1.2/css/themify-icons.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta2/css/all.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">
    <title>OLD SmartHome</title>
     <!-- Favicon -->
    ...
    <link rel="stylesheet" type="text/css" href="Customer/css/lightbox.min.css">
    <script type="text/javascript" src="Customer/js/lightbox-plus-jquery.min.js"></script>
</head>
   <!-- Navbar Start -->
   <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="index.php" class="navbar-brand d-flex align-items-center text-center">
                    ...
                    <h1 class="m-0 text-primary">OLD SmartHome</h1>
                </a>
