                ...
                <div class="row g-4">
                    ...
                    ?>
                            <div class="col-lg-3 col-sm-6 wow fadeInUp list_house" data-wow-delay="0.1s" >
                                 <!-- thẻ a -->
                                <a href="index_typeHome.php?id_typeHome=<?php echo $row['id_typeHome']?>" class="cat-item d-block bg-light text-center rounded p-3" >  
                ...
                <div class="row g-0 gx-5 align-items-end">
                    <div class="col-lg-6">
                        <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                            <h1 class="mb-3">OLD SmartHome</h1>
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href="detail_home.php?id_home=<?=$row['id_home']?>"><img style="height:230px; width:100%; object-fit:cover; justify-content: cover; border-radius: 2px;" class="" src="../image/<?php echo $row['image1'] ?>" alt=""></a>
                                    </div>
                                    <div class="p-2">
      ...
      <div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="container py-5">
                ...
                <div class="col-lg-6 col-md-6">
                            ...
                            <div style="margin-left:58%;" class="d-flex pt-6">
