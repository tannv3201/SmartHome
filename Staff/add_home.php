...
<section class="view" id="order">
    ...
    <form action="" method="POST" class="register" enctype="multipart/form-data">
        ...
        <div class="inputBox">
            <div class="input">
                <span>Loại nhà</span>
                <select name="id_typeHome" class="typeAccount" required>
                    <?php
            ...
            <div class="input">
                ...
                <input type="text" name="nameHome" placeholder="Nhập tên căn hộ" required>
            </div>
        </div>
        <div class="inputBox">
            <div class="input">
                <span>Giá bán</span>
                <input type="text" name="priceHome" placeholder="Nhập giá" required>
            </div>
            <div class="input">
                <span>Giảm giá</span>
        ...
        <div class="inputBox">
            <div class="input">
                <span>Diện tích</span>
                <input type="text" name="areaHome" placeholder="Diện tích" required>
            </div>
            <div class="input">
                <span>Địa chỉ</span>
